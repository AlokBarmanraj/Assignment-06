    ...
    <div className="bg-white pt-22 pb-22">
      <div className="max-w-9/12 mx-auto">
        ...
        <div className="text-center pb-8 space-y-3 text-black">
          <h1 className="text-4xl lg:text-5xl font-bold">Simple, Transparent Pricing</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-gradient-to-r from-[#4A00E0] via-[#6A11CB] to-[#8E2DE2] text-white p-5 rounded-2xl space-y-4">
            <div>
            ...
            <button className="btn bg-white w-full rounded-full border-none">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#4A00E0] via-[#6A11CB] to-[#8E2DE2] px-5">Start Pro Trial</span>
            </button>
          </div>
